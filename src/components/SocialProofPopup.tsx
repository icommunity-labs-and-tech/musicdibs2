...
const NAMES_BY_LANG: Record<string, string[]> = {
  es: ["Carlos", "María", "Alejandro", "Lucía", "Diego", "Valentina", "Andrés", "Sofía", "Pablo", "Camila", "Javier", "Laura", "Mateo", "Ana"],
  en: ["James", "Emma", "Liam", "Olivia", "Noah", "Ava", "Marcus", "Sophia", "Tyler", "Mia", "Ethan", "Chloe", "Ryan", "Zoe"],
  "pt-BR": ["Lucas", "Beatriz", "Gabriel", "Mariana", "Pedro", "Isabela", "Rafael", "Larissa", "Gustavo", "Camila", "Thiago", "Julia"],
  fr: ["Lucas", "Léa", "Hugo", "Manon", "Louis", "Camille", "Nathan", "Chloé", "Théo", "Emma", "Raphaël", "Jade"],
  it: ["Marco", "Giulia", "Luca", "Chiara", "Alessandro", "Francesca", "Matteo", "Sara", "Lorenzo", "Elena", "Andrea", "Valentina"],
  de: ["Lukas", "Anna", "Felix", "Sophie", "Maximilian", "Marie", "Leon", "Lena", "Jonas", "Laura", "Tim", "Hannah"],
};

const CITIES_BY_LANG: Record<string, string[]> = {
  es: ["Madrid", "Barcelona", "Buenos Aires", "Ciudad de México", "Bogotá", "Lima", "Santiago", "Medellín", "Sevilla", "Valencia"],
  en: ["London", "New York", "Los Angeles", "Toronto", "Sydney", "Miami", "Chicago", "Austin", "Nashville", "Atlanta"],
  "pt-BR": ["São Paulo", "Rio de Janeiro", "Lisboa", "Porto", "Belo Horizonte", "Curitiba", "Brasília", "Salvador", "Recife", "Fortaleza"],
