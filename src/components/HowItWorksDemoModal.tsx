  ...
  const dict: Record<string, any> = {
    es: {
      ...
      step1: {
        ...
        placeholder: "Canción pop latina de amor. Con voz masculina.",
        promptExample: "Canción pop latina de amor. Con voz masculina.",
    ...
    en: {
      ...
      step1: {
        ...
        placeholder: "Latin pop love song. With male vocals.",
        promptExample: "Latin pop love song. With male vocals.",
    ...
    pt: {
      ...
      step1: {
        ...
        promptExample: "Canção pop latina de amor…",
        voicePop: "Voz Pop Latina",
        voiceUrban: "Urbano",
        voiceIndie: "Indie",
