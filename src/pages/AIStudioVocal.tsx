...
export default function AIStudioVocal() {
  ...
  const vc = (key: string, opts?: any) => t(`dashboard.voiceCloning.${key}`, opts);
  const tv = (key: string, opts?: any) => t(`aiVocal.${key}`, opts);
        ...
        <main className="container mx-auto px-4 py-12 pt-24">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-4">
              ...
              <span className="text-sm font-medium">{t('aiVocal.voiceTools', 'Herramientas de Voz')}</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">{t('aiVocal.voiceToolsTitle', 'Herramientas de Voz')}</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              {t('aiVocal.voiceToolsSubtitle', 'Tu estudio vocal IA: clona tu voz, canta en 29 idiomas, traduce audios y mucho más')}
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <Card className="border-primary/30 bg-primary/5">
              <CardContent className="py-8 text-center space-y-4">
                ...
                <h2 className="text-2xl font-bold">{t('aiVocal.firstTimeTitle', '¡Empieza aquí! Clona tu voz')}</h2>
                <p className="text-muted-foreground max-w-md mx-auto">
                  {t('aiVocal.firstTimeDesc', 'Para usar cualquier herramienta, primero necesitas clonar tu voz. Solo toma 30 segundos.')}
                </p>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="max-w-5xl mx-auto">
          <TabsList className="grid w-full grid-cols-3 mb-8">
            <TabsTrigger value="sing" className="gap-2">
              ...
              <span className="hidden sm:inline">{t('aiVocal.tabSing', 'Cantar')}</span>
            </TabsTrigger>
            <TabsTrigger value="clone" className="gap-2">
              <Mic className="h-4 w-4" />
              <span className="hidden sm:inline">{t('aiVocal.tabClone', 'Clonar')}</span>
            </TabsTrigger>
            <TabsTrigger value="translate" className="gap-2">
              <Globe className="h-4 w-4" />
              <span className="hidden sm:inline">{t('aiVocal.tabTranslate', 'Traducir')}</span>
            </TabsTrigger>
          </TabsList>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {t('aiVocal.translateTitle', 'Traductor de voz')}
                </CardTitle>
                <CardDescription>
                  {t('aiVocal.translateSubtitle', 'Traduce audios existentes a otros idiomas manteniendo tu timbre')}
                </CardDescription>
              </CardHeader>
              <CardContent>
  ...
  function renderComingSoonTools(locked: boolean) {
    const tools = [
      { icon: Sparkles, title: t('aiVocal.comingSoonMorphTitle', 'Voice Morphing'), desc: t('aiVocal.comingSoonMorphDesc', 'Cambia género, edad y características de tu voz') },
      { icon: Palette, title: t('aiVocal.comingSoonEmotionTitle', 'Emotion Control'), desc: t('aiVocal.comingSoonEmotionDesc', 'Añade emociones: alegre, triste, enérgico...') },
      { icon: Users, title: t('aiVocal.comingSoonMixTitle', 'Voice Mixing'), desc: t('aiVocal.comingSoonMixDesc', 'Mezcla dos voces clonadas en una') },
    ];

    return (
      <div className="space-y-3">
        <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">
          {t('aiVocal.comingSoonLabel', 'Próximamente')}
        </h3>
            ...
            <Card key={idx} className="relative overflow-hidden opacity-60">
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="text-[10px]">{t('aiVocal.comingSoonBadge', 'Próximamente')}</Badge>
                </div>
