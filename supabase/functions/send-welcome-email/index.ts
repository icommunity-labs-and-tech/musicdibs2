    ...
    <tr><td align="center" style="padding:40px 20px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background-color:#1a0a2e;border-radius:16px;padding:40px 36px;">
          <h1 style="margin:0 0 16px;color:#f3f4f6;font-size:24px;font-weight:700;text-align:center;">¡Bienvenido, ${escapeHtml(name)}!</h1>
          <p style="margin:0 0 28px;color:#d1d5db;font-size:15px;line-height:1.7;text-align:center;">Tu cuenta en MusicDibs está lista. Ahora puedes registrar tus obras musicales en blockchain y proteger tu propiedad intelectual de forma permanente e inmutable.</p>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
            <tr>
              ...
              <td style="padding-bottom:16px;border-bottom:1px solid rgba(168,85,247,0.15);">
                ...
                <p style="margin:4px 0 0;color:#9ca3af;font-size:13px;">Sube tu archivo de audio, vídeo o documento.<br/><a href="${registerUrl}" style="color:#a855f7;text-decoration:none;">Ir a Registrar obra →</a></p>
              </td>
            </tr>
          </table>
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
            <tr>
              ...
              <td>
                ...
                <p style="margin:4px 0 0;color:#9ca3af;font-size:13px;">Cada registro consume 1 crédito.<br/><a href="${creditsUrl}" style="color:#a855f7;text-decoration:none;">Ver planes y precios →</a></p>
              </td>
            </tr>
          </table>
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
              <a href="${dashboardUrl}" style="display:inline-block;padding:14px 40px;background:linear-gradient(135deg,#a855f7,#7c3aed);color:#fff;font-size:15px;font-weight:600;text-decoration:none;border-radius:10px;">Ir a mi panel →</a>
            </td></tr>
          </table>
        </td></tr>
        <tr><td style="padding:28px 20px 0;text-align:center;">
          <p style="margin:0;color:#6b7280;font-size:11px;line-height:1.6;">Este correo fue enviado automáticamente porque te registraste en MusicDibs.<br/><a href="https://musicdibs.com" style="color:#9ca3af;text-decoration:none;">musicdibs.com</a> · <a href="${dashboardUrl}" style="color:#9ca3af;text-decoration:none;">Mi panel</a> · <a href="https://musicdibs.com/contact" style="color:#9ca3af;text-decoration:none;">Soporte</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
