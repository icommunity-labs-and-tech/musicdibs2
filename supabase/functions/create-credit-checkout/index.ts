...
const PLANS: Record<string, { priceId: string; credits: number }> = {
  basic: { priceId: "price_1T8mCQFULeu7PzK6IwtDV0i4", credits: 10 },
  plus: { priceId: "price_1T8mbTFULeu7PzK608MKWRtS", credits: 50 },
  pro: { priceId: "price_1T8mduFULeu7PzK6baYJ0VSz", credits: 200 },
};
