    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={card}>
          ...
          <Text style={footer}>Este código caduca en breve. Si no lo solicitaste, puedes ignorar este email.</Text>
        </Section>
...
const codeStyle = { fontFamily: "'Courier New', Courier, monospace", fontSize: '28px', fontWeight: '800' as const, color: '#a855f7', margin: '0 0 30px', letterSpacing: '4px' }
