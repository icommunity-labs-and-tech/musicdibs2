    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>Haz clic en el botón para acceder a MusicDibs. Este enlace caduca en breve.</Text>
          <Button style={button} href={confirmationUrl}>
            Acceder a MusicDibs →
          </Button>
          <Text style={footer}>Si no solicitaste este enlace, puedes ignorar este email.</Text>
        </Section>
